...
public class Tile {
    private int x, y, w, h;
    private HashSet<Environment.Element> elements = new HashSet<Environment.Element>();

    /**
     * The roboBomb.Tile constructor.
     *
     ...
     */
    public boolean contains(Environment.Element element) {
     ...
     */
    public void setItem(Environment.Element element) {
